  ...
  <%--   <link type="text/css" rel="stylesheet" href="<c:url value='/css/egovframework/sample.css'/>"/> --%>
    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_egov_save() {
        	...
        	var tour_code = detailForm.tour_code.value;
    		var tour_name = detailForm.tour_name.value;
    		var tour_add = detailForm.tour_add.value;
    		var city_code = detailForm.city_code.value;
    		if(tour_code == ""){
    			alert("관광지 코드를 입력하세요");
    			detailForm.tour_code.focus();
    			return false;
    		}
    		 
    		if(tour_name == ""){
    			alert("관광지 이름을 입력하세요");
    			detailForm.tour_name.focus();
    			return false;
    		}
    		
    		if(tour_add == ""){
    			alert("관광지 주소를 입력하세요");
    			detailForm.tour_add.focus();
    			return false;
    		}
    		
    		if(city_code == ""){
    			alert("도시코드를 입력하세요");
    			detailForm.city_code.focus();
    			return false;
    		}

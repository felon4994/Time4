...
<script type="text/javascript">
	...
	function fn_egov_link_page(pageNo) {
		...
		document.listForm.action = "<c:url value='/BorderPage.do'/>";
...
<body>
	...
	<!-- <p style="text-align: center">
		<ul class="pagination">
			<li class="page-item disabled"><a class="page-link" href="/NonUserPage.do">지역선택</a></li>			
		</ul>
		<a class="btn btn-default" role="button" onclick="history.back(-1)">이전 페이지</a>
		<a class="btn btn-default" role="button"onclick="history.forward(+1)">다음 페이지</a>
	</p> -->

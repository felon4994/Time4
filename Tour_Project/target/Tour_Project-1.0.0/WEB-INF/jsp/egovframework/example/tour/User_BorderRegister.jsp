...
<head><meta charset="utf-8">
    ...
    <c:set var="registerFlag" value="${empty User_BorderVO.userno ? 'create' : 'modify'}"/>
    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_egov_selectList() {
        	document.listForm.action = "<c:url value='/UserBorderList.do'/>";
        ...
        function fn_egov_delete() {
           	document.detailForm.action = "<c:url value='/deleteUserBorder.do'/>";
            ...
            if(con_test == true){
              ...
              document.detailForm.action ="<c:url value='/UserBorderList.do'/>";
            }
        ...
        //        return;
        //    }else{
            	frm.action = "<c:url value="${registerFlag == 'create' ? '/addUserBorder.do' : '/updateUserBorder.do'}"/>";
                frm.submit();
         //   }
        }
...
<form:form commandName="User_BorderVO" id="detailForm" name="detailForm">
    <div id="content_pop">
    	<!-- 타이틀 -->
    	<div id="title">
    		<ul>
    	...
    	<table width="80%" border="1" cellpadding="0" cellspacing="0" style="bordercolor:#D3E2EC; bordercolordark:#FFFFFF; BORDER-TOP:#C2D0DB 2px solid; BORDER-LEFT:#ffffff 1px solid; BORDER-RIGHT:#ffffff 1px solid; BORDER-BOTTOM:#C2D0DB 1px solid; border-collapse: collapse;">
    		<colgroup>
       		...
       		<tr>
       			<td class="tbtd_caption"><label for="userno">번호</label></td>
       			<td class="tbtd_content">
       				<form:input path="userno" rows="5" cols="58" />&nbsp;<form:errors path="userno" />
       			</td>
       		</tr>
    		...
    		<tr>
    			...
    			<td class="tbtd_content">
    				<form:input path="title" rows="5" cols="58" />&nbsp;<form:errors path="title" />
    			</td>
    		</tr>
    		...
    		<tr>
    			...
    			<td class="tbtd_content">
    				<form:input path="username" rows="5" cols="58" />&nbsp;<form:errors path="username" />
                </td>
    		</tr>
